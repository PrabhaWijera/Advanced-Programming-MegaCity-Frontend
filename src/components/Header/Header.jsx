          ...
          <Row>
            <Col lg="6" md="6" sm="6">
              <div className="header__top__left">
                <span>Your reliable ride is just a call away!</span>
                <span className="header__top__help">
                  <i className="ri-phone-fill"></i> +94 760368019
                </span>
              </div>
            </Col>
              ...
              <div className="logo">
                <h1>
                  <Link to="/home" className=" d-flex align-items-center gap-2">
                    <img className="w-25 rounded-circle shadow-lg" src={logo} alt="logo" />
                    <span>
